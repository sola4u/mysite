...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30, verbose_name='catagory')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='post_time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=16, verbose_name='tag')),
            ],
        ),
        migrations.AddField(
            model_name='blog',
